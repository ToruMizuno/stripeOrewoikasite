class HomeController < ApplicationController
  # クレジットカード情報を送ってストライプトークンがcreateアクションに送られてくるので
  ...
  def create
    ...
    if params[:stripeToken] != nil
      ...
      if customer.id != nil 
        ...
        plan = Plan.find_by(id: 1)# idが1のPlanしか無いので1で良い(フォームで選ばせるようにすると良い)
        ...
        begin
          Team.transaction() do
            ...
            subscription = Stripe::Subscription.create({
              ...
              # キャンセルしたら即座に使えなくなる(Planが'licensed'で前払い性なので金額は関係ない)
  ...
  # httpメソッドはput
  # restart.html.erbのrestartボタンで発動
  def restart_subscription
    ...
    # アップデートができるか試す
    # team.update( plan_id: 'plan_49ty4767H20z6a', stripe_subscription_id: 'sub_49ty4767H20z6a', active_until: Time.at(Time.now.to_i))
